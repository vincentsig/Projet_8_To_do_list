...
![bundle-list](/images/bundle-list.png)
...
Maintenant jettons un oeil au ficher `security.yaml` présent dans notre application ToDo & Co.  
 ![security.yaml](/images/security.png)
...
![authenticator_enable](/images/authenticator_enable.png)

- **access_control**

![acces_control](/images/access_control.png)
...
![voters](/images/voters_controller.png)
